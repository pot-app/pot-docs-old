...
2. 下载 pot 的 `SnipDo` 扩展:
   ...
   <Link
     ...
     to="https://gh.pylogmon.cn/https://github.com/Pylogmon/pot/releases/latest/download/pot.pbar"
   >
...
2. 下载 pot 的 `PopClip` 插件:
   ...
   <Link
     className="button button--primary button--lg"
     to="https://gh.pylogmon.cn/https://github.com/Pylogmon/pot/releases/latest/download/Pot.popclipextz"
   >
     <div style={{ display: "flex", justifyContent: "space-between" }}>
       <BsDownload style={{ margin: "auto", marginRight: "14px" }} />
       <span>点击下载</span>
